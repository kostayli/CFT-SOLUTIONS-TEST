...
create table type (id bigint not null AUTO_INCREMENT, name_description varchar(255)  , name_type varchar(255),
                   description_features varchar(255), primary key (id));
create sequence hibernate_sequence start with 1 increment by 1;
INSERT INTO type(name_description,name_type,description_features) VALUES('Форм-фактор',
                 'настольный компьютер','{variants:[десктоп,неттоп,моноблок]}');
